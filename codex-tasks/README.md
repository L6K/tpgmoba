...
| 03 | [03-vision-reveal-model.md](03-vision-reveal-model.md) | VisionRevealModel（視界源/対象から可視判定する plain C#・linger付き + テスト）。提案E（Fog of War）の核 | 完了: [report](03-vision-reveal-model-report.md) |
